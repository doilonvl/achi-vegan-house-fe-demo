...
export default async function BlogPage({ params, searchParams }: PageParams) {
  ...
  return (
    <div className="relative overflow-hidden bg-white">
      ...
      />
      <BlogListMotion>
        <div className="relative z-10 mx-auto max-w-6xl px-4 pb-16 pt-10 md:px-6 md:pt-14 lg:px-8">
          <section className="relative overflow-hidden rounded-[36px] border border-neutral-200/60 bg-white shadow-[0_30px_90px_-60px_rgba(15,23,42,0.6)]">
            ...
            <div className="relative flex flex-col gap-4 p-8 md:p-12">
              <div
                data-hero
                className="inline-flex w-fit items-center gap-2 rounded-full border border-emerald-300/60 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-emerald-800 backdrop-blur"
              >
                Achi Vegan House
              </div>
              <h1
              ...
              <p
                data-hero
                className="max-w-2xl text-sm text-neutral-700/85 md:text-base"
              >
                {t("subtitle")}
              </p>
              {tag ? (
